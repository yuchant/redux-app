  ...
  return {
    onChangeMicroStep: (event, step) => {
      if (event.target.checked) {
        ...
        const message = (<div>Added <StyledNotificationEmphasis>{step.text}</StyledNotificationEmphasis>. Visit <Link to="/micro-steps">Your Micro Steps!</Link></div>);
        dispatch(flashNotification(message, 5000));
      } else {
      ...
      <div>
        ...
        <StyledSubtitle>
          <Typography align='center'>
            We've created a way for you to learn how to apply the lessons from this article. Add the Micro Steps you're interested into your daily ritual!
          </Typography>
        </StyledSubtitle>
        <StyledStepsWrapper>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(ArticleMicroSteps));
